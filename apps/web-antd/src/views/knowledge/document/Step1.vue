...
<template>
  <div>
    ...
    <div class="mt-6 flex justify-end gap-3">
      <a-button type="primary" danger variant="solid" @click="() => window.history.back()">取消</a-button>
      <a-button type="primary" variant="solid" :loading="loading" @click="handleNext">
        下一步></a-button>
    </div>
  </div>
</template>
