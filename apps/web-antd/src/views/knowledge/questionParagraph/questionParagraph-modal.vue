<script setup lang="ts">
    ...
    import { questionParagraphAdd, questionParagraphInfo, questionParagraphUpdate } from './api';
    ...
    async function handleConfirm() {
        try {
            ...
            await (isUpdate.value ? questionParagraphUpdate(data) : questionParagraphAdd(data));
